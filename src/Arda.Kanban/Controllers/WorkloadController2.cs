...
namespace Arda.Kanban.Controllers
{
    ...
    public class WorkloadController2 : Controller
    {
        ...
        public WorkloadController2(IWorkloadRepository repository, Models.KanbanContext context)
        {
        ...
        [HttpGet]
        [Route("list")]
        public IEnumerable<WorkloadsByUserViewModel> List([FromQuery]string tag)
        {
            // _extraRepo.AssignTag(Guid.Parse("341ABE0F-DEF3-406E-AD33-02924AAC6D0E"), "tag");

...
namespace ArdaSDK.Kanban
{
    ...
    public partial class Workspaces : IServiceOperations<KanbanClient>, IWorkspaces
    {
        ...
        /// </return>
        public async Task<HttpOperationResponse<string>> RootWithHttpMessagesAsync(string workspaceId, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (workspaceId == null)
            {
            ...
            if (_shouldTrace)
            {
                ...
                ServiceClientTracing.Enter(_invocationId, this, "Root", tracingParameters);
            }
            // Construct URL
            var _baseUrl = Client.BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "v2/Workspaces/{workspaceId}").ToString();

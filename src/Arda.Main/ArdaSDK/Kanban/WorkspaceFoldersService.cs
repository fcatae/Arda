...
namespace ArdaSDK.Kanban
{
    ...
    /// </summary>
    public partial class WorkspaceFoldersService : IServiceOperations<KanbanClient>, IWorkspaceFoldersService
    {
        /// <summary>
        /// Initializes a new instance of the WorkspaceFoldersService class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        public WorkspaceFoldersService(KanbanClient client)
        {
            if (client == null)
            {
        ...
        public async Task<HttpOperationResponse<IList<WorkspaceItem>>> ListItemsWithHttpMessagesAsync(string folderId, string type = default(string), string props = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new HttpOperationResponse<IList<WorkspaceItem>>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Microsoft.Rest.Serialization.SafeJsonConvert.DeserializeObject<IList<WorkspaceItem>>(_responseContent, Client.DeserializationSettings);
                }
        ...
        public async Task<HttpOperationResponse<object>> AddItemWithHttpMessagesAsync(string folderId, AddItemInput workloadInput = default(AddItemInput), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if (_shouldTrace)
            {
                ...
                Dictionary<string, object> tracingParameters = new Dictionary<string, object>();
                tracingParameters.Add("folderId", folderId);
                tracingParameters.Add("workloadInput", workloadInput);
                tracingParameters.Add("cancellationToken", cancellationToken);
                ServiceClientTracing.Enter(_invocationId, this, "AddItem", tracingParameters);
            }
            // Construct URL
            var _baseUrl = Client.BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "v2/folders/{folderId}/add").ToString();
            _url = _url.Replace("{folderId}", System.Uri.EscapeDataString(folderId));
            // Create HTTP transport objects
            var _httpRequest = new HttpRequestMessage();
            HttpResponseMessage _httpResponse = null;
            ...
            if(workloadInput != null)
            {
                _requestContent = Microsoft.Rest.Serialization.SafeJsonConvert.SerializeObject(workloadInput, Client.SerializationSettings);
